...
to move-snails ;; calls the appropriate movement mode for the snails based on the settings
  ...
  ask snails [
     ...
     [set sm random 100  ;generates a random integer between 0 and 100
...
;;  resource regrowth
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
to regrow ;; after patch is below resource density and no snail is on it, restore to orginal resource density
  ask patches with [not any? turtles-here][
    if (coverage <= GUD and coverage > 0 and regrow_prob > random 100)[set coverage initial-algae-coverage
      set pcolor green]
  ]
end
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
<experiments>
  ...
  <experiment name="FinalSim_24Oct23" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="50"/>
    <metric>resource-level</metric>
    ...
    <enumeratedValueSet variable="regrow_prob">
      <value value="0"/>
      <value value="100"/>
    </enumeratedValueSet>
  </experiment>
